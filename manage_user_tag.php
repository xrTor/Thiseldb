...
if ($search !== '') {
  ...
  $stmt->bind_param("sssi", $searchLike, $searchLike, $searchLike, $limit);
} else {
...
<head>
  ...
  <style>
    ...
    table { width:100%; border-collapse:collapse; margin-top:30px; background-color: white; table-layout: fixed; /* חשוב לשליטה על רוחב העמודות */ }
    th, td { padding:10px; border-bottom:1px solid #eee; text-align:right; vertical-align:top; word-wrap: break-word; /* שובר מילים ארוכות */ }
...
<table>
  <thead>
    <tr>
        <th style="width: 3%;">מזהה</th>
        <th style="width: 35%;">שם</th>
        <th style="width: 20%;">תגיות</th>
    </tr>
  </thead>
  <tbody>

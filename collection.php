<?php
session_start(); // <-- הוסף שורה זו בראש הקובץ
...
<head>
  ...
  <style>
    ...
    /* ==========================================================
       === CORRECTED ADMIN VISIBILITY RULES (START) ===
       ========================================================== */
    
    /* 1. By default, hide the main admin panel and the pin/delete boxes. */
    #manage-controls,
    .pin-box,
    .delete-box {
    ...
    /* 2. When admin mode is active, show the main admin panel. */
    .admin-mode #manage-controls {
        display: block !important;
    }

    /* 3. Show pin boxes ONLY if BOTH admin mode AND pin mode are active. */
    body.admin-mode.show-pin-controls .pin-box {
        display: inline-block !important;
    }

    /* 4. Show delete boxes ONLY if BOTH admin mode AND delete mode are active. */
    body.admin-mode.show-delete-controls .delete-box {
        display: inline-block !important;
    }
    
    /* NOTE: The main '.admin-toggle' button is visible by default on this page,
       as the rule that was hiding it has been removed. */

    /* ========================================================
       === CORRECTED ADMIN VISIBILITY RULES (END) ===
       ======================================================== */
  </style>
</head>
<body><br>
...
<script>
  function deleteAllContent(collectionId) { if (confirm('האם אתה בטוח שברצונך למחוק את כל הפוסטרים מאוסף זה? הפעולה אינה הפיכה.')) { window.location.href = 'collection.php?id=' + collectionId + '&delete_all_content=1'; } }
  ...
  // ========================================================
  // === UNIFIED ADMIN MODE SCRIPT (START) ===
  // ========================================================
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize individual control visibility
